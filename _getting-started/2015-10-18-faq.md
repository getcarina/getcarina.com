...
We've published a tutorial to [troubleshoot common problems]({{ site.baseurl }}/docs/tutorials/troubleshooting/). If you continue to have problems, use our [forums and ask our community](https://community.getcarina.com).


#### How does autoscaling work in Carina?

Carina currently offers simple scale-up capabilities. For details, see the [Autoscaling resources in Carina ]({{ site.baseurl }}/docs/tutorials/autoscaling-carina/) tutorial.
