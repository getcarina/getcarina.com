...
To get started with the hosted environment of Carina, read the [Overview of Carina](/docs/overview-of-carina/) and then see how easy it is to run an application in a container by completing the steps in [Getting started on Carina](/docs/getting-started/getting-started-on-carina/).
