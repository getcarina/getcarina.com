...
1. [Create and connect to a cluster]({{ site.baseurl }}/docs/tutorials/create-connect-cluster/)

1. A Rackspace cloud account. If you don't have a Rackspace cloud account, you can
sign up for one.
...
This process might take a while, as the container will self-update. The expected
...
1. Ctrl-C to go back to the terminal. 
...
The rest of the setup wizard establishes your IRC identity, and is beyond the scope
of this tutorial.
...
Your data will be backed up every minute. This is not a rolling backup; only the last
instance of your data is saved automatically, to reduce storage costs (data is
...
This command downloads your data from Rackspace Cloud Files to the `quassel-backup`
volume container a single time. The output should look as follows:
