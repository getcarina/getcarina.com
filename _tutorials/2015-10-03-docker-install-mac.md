...
EDIT: [Docker for Mac](https://www.docker.com/products/docker#/mac) is availble for Apple macOS Yosemite 10.10.3 or above. Follow the instructions below To install docker on previous versions of Mac OS X.
