...
EDIT: [Docker for Mac](https://www.docker.com/products/docker#/mac) is availble for Apple macOS Yosemite 10.10.3 and above. Follow the instructions below to install docker on previous versions of Mac OS X.
